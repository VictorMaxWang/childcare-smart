# SCFR-093-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_meal_tracking_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_meal_tracking_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_meal_tracking_dashboard_interface.png`
- Priority: P1
...
- Extracted palette: `#C0C0D0`, `#D0D0D0`, `#C0C0C0`, `#C0D0D0`, `#FFFFFF`, `#E0E0E0`
