# SCFR-082-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_management_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_management_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_management_dashboard_overview.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#F0FFFF`, `#E0E0F0`, `#FFF0F0`
