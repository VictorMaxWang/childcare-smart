# SCFR-044-director-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_records_management_app_interface.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_records_management_app_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_records_management_app_interface.png`
- Priority: P2
