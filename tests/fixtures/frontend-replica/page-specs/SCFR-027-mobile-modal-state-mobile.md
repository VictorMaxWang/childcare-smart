# SCFR-027-mobile-modal-state-mobile

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/child_friendly_app_interface_with_locked_content.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/child_friendly_app_interface_with_locked_content.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_friendly_app_interface_with_locked_content.png`
- Priority: P1
