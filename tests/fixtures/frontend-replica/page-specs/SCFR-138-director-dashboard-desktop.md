# SCFR-138-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/health_document_management_platform_dashboard.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/health_document_management_platform_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `health_document_management_platform_dashboard.png`
- Priority: P0
