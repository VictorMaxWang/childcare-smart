# SCFR-212-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_nutrition_tracking_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_nutrition_tracking_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_nutrition_tracking_dashboard.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#F0FFFF`, `#E0E0FF`
