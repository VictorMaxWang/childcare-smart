# SCFR-147-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/imagegen.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/imagegen.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `imagegen.png`
- Priority: P2
