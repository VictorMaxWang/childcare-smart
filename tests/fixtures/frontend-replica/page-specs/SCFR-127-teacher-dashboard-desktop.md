# SCFR-127-teacher-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/classroom_health_check_in_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/classroom_health_check_in_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `classroom_health_check_in_dashboard_overview.png`
- Priority: P0
