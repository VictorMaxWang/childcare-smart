# SCFR-236-teacher-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/teacher_dashboard_with_class_overview_and_tasks.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/teacher_dashboard_with_class_overview_and_tasks.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `teacher_dashboard_with_class_overview_and_tasks.png`
- Priority: P0
