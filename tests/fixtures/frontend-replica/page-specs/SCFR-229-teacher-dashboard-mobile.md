# SCFR-229-teacher-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/teacher_app_morning_health_check_dashboard.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/teacher_app_morning_health_check_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `teacher_app_morning_health_check_dashboard.png`
- Priority: P0
