# SCFR-024-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/child_care_platform_web_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/child_care_platform_web_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_care_platform_web_dashboard_ui.png`
- Priority: P2
