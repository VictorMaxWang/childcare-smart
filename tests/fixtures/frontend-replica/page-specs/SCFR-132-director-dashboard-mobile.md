# SCFR-132-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/daycare_admin_app_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/daycare_admin_app_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `daycare_admin_app_dashboard_overview.png`
- Priority: P0
