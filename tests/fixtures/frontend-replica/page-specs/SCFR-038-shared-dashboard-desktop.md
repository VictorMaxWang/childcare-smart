# SCFR-038-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_profile_dashboard_in_pastel_tones.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_profile_dashboard_in_pastel_tones.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_profile_dashboard_in_pastel_tones.png`
- Priority: P2
