# SCFR-160-login-auth-login-tablet-portrait

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_login_screen.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_login_screen.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_childcare_platform_login_screen.png`
- Priority: P0
- Original role: login
