# SCFR-085-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_management_platform_dashboard_layout.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_management_platform_dashboard_layout.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_management_platform_dashboard_layout.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0F0`, `#FFFFF0`, `#F0FFFF`
