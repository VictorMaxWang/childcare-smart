# SCFR-037-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_profile_dashboard_in_pastel_design.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_profile_dashboard_in_pastel_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_profile_dashboard_in_pastel_design.png`
- Priority: P2
