# SCFR-134-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/education_communication_app_dashboard_design.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/education_communication_app_dashboard_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `education_communication_app_dashboard_design.png`
- Priority: P1
