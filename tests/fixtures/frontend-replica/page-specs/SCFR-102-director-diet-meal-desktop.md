# SCFR-102-director-diet-meal-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_platform_diet_record_management.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_platform_diet_record_management.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_platform_diet_record_management.png`
- Priority: P1
...
- Extracted palette: `#F0F0FF`, `#FFFFFF`, `#F0FFFF`, `#F0F0F0`, `#E0E0F0`, `#B0B0FF`
