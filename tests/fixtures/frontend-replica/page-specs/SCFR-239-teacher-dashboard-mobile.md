# SCFR-239-teacher-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/teacher_parent_communication_dashboard_in_pastel_u.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/teacher_parent_communication_dashboard_in_pastel_u.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `teacher_parent_communication_dashboard_in_pastel_u.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0F0`, `#F0FFFF`, `#D0D0FF`
...
- Colors: #6050FF, #21C6C1, #F59E0B, #EF4444, #10B981
