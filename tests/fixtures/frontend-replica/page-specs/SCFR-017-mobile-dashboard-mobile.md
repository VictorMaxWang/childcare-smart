# SCFR-017-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/child_care_app_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/child_care_app_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_care_app_dashboard_overview.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#E0E0E0`, `#E0E0F0`
