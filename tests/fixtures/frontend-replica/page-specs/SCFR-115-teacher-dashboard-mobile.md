# SCFR-115-teacher-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_teacher_dashboard_ui_overview.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_teacher_dashboard_ui_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_teacher_dashboard_ui_overview.png`
- Priority: P0
