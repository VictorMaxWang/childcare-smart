# SCFR-207-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_management_app_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_management_app_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_management_app_dashboard.png`
- Priority: P0
