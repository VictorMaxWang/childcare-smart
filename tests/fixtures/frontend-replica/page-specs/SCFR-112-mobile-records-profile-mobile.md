# SCFR-112-mobile-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_profile_app_interface_design.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_profile_app_interface_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_profile_app_interface_design.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0E0`, `#E0F0F0`, `#FFF0FF`
