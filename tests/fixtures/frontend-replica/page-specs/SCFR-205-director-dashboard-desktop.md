# SCFR-205-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_health_management_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_health_management_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_health_management_dashboard.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#FFF0F0`, `#E0F0F0`
