# SCFR-048-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_risk_consultation_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_risk_consultation_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_risk_consultation_dashboard_overview.png`
- Priority: P2
