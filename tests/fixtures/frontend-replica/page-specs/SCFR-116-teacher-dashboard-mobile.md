# SCFR-116-teacher-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_teacher_platform_dashboard_mockup.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_teacher_platform_dashboard_mockup.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_teacher_platform_dashboard_mockup.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#FFF0F0`, `#E0E0F0`
