# SCFR-072-mobile-health-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_health_check_app_interface.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_health_check_app_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_health_check_app_interface.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#FFF0F0`, `#E0E0E0`, `#E0E0FF`
