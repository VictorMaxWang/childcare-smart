# SCFR-092-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_meal_record_management_dashboard.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_meal_record_management_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_meal_record_management_dashboard.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0E0`, `#F0FFFF`, `#E0F0F0`
