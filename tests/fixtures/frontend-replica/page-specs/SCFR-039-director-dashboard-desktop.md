# SCFR-039-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_profile_management_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_profile_management_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_profile_management_dashboard_ui.png`
- Priority: P0
