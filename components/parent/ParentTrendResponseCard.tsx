...
export default function ParentTrendResponseCard({
  ...
  return (
    <div
      className="content-reading-panel rounded-[28px] p-5 shadow-sm"
    ...
    >
      ...
      {displayError ? (
        <div className="content-focus-block mt-4 rounded-2xl border-rose-100/80 p-4 text-sm leading-7 text-rose-800">
          {displayError}
        </div>
      ) : null}
      ...
      {result ? (
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          <div className="content-reading-panel rounded-2xl p-4">
      ...
      {result ? (
        <div className="mt-4 space-y-4">
          {fallbackUsed ? (
            <div className="content-focus-block rounded-[20px] border-emerald-100/80 px-4 py-3 text-sm leading-6 text-emerald-900">
              当前结果来自演示快照，已明确标记为非实时机构数据，适合演示趋势结构。
            </div>
          ) : null}

          <div className="content-focus-block rounded-2xl p-4">
          ...
          <div className="content-form-panel rounded-2xl p-4">
