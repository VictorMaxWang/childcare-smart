...
test("teacher-agent weekly summary surfaces Lin Xiaoyu parent feedback writeback", () => {
  ...
  const classContext = buildTeacherAgentClassContext({
    ...
    guardianFeedbacks: [
      {
        feedbackId: "feedback-defense-c-1",
        id: "feedback-defense-c-1",
        childId: "c-1",
        sourceRole: "parent",
        ...
        barriers: [],
        notes: "固定演示反馈，不应覆盖用户刚提交的回流。",
        attachments: {},
        submittedAt: `${today}T23:59:00.000Z`,
        source: { kind: "structured", workflow: "defense-demo-feedback" },
        fallback: {},
        date: `${today}T23:59:00.000Z`,
        status: "completed",
        content: "固定演示反馈，不应覆盖用户刚提交的回流。",
