# SCFR-046-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_records_management_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_records_management_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_records_management_dashboard_ui.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#E0F0F0`, `#E0E0E0`
