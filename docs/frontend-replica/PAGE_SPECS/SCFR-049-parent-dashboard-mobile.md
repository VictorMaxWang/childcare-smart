# SCFR-049-parent-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_s_growth_storybook_dashboard_design.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_s_growth_storybook_dashboard_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_s_growth_storybook_dashboard_design.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0F0`, `#E0E0E0`, `#FFF0FF`
