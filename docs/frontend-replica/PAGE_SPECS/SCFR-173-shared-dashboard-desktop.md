# SCFR-173-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_saas_dashboard_for_weekly_reports.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_saas_dashboard_for_weekly_reports.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_saas_dashboard_for_weekly_reports.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0F0`, `#F0FFFF`, `#E0E0FF`
