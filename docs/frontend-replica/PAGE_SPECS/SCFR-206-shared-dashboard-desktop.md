# SCFR-206-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_health_monitoring_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_health_monitoring_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_health_monitoring_dashboard.png`
- Priority: P1
