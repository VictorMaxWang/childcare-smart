# SCFR-192-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/playful_mobile_app_dashboard_design.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/playful_mobile_app_dashboard_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `playful_mobile_app_dashboard_design.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#E0E0F0`, `#F0FFF0`
