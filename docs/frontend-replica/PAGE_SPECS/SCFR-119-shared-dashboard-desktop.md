# SCFR-119-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_workspace_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_workspace_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_workspace_dashboard_interface.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0FF`, `#F0FFFF`, `#E0E0E0`
