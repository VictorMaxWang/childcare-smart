# SCFR-131-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/confirmation_popup_in_child_care_dashboard.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/confirmation_popup_in_child_care_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `confirmation_popup_in_child_care_dashboard.png`
- Priority: P1
...
- Extracted palette: `#A0A0A0`, `#A0A0B0`, `#9090A0`, `#90A0A0`, `#FFFFFF`, `#909090`
