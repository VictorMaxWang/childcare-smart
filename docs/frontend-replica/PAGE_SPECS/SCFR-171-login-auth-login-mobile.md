# SCFR-171-login-auth-login-mobile

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_mobile_app_login_ui_design.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_mobile_app_login_ui_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_mobile_app_login_ui_design.png`
- Priority: P0
- Original role: login
- Normalized role: login
- Page type: login, mobile
- Target route: `/login`
