# SCFR-109-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_platform_user_interface_dashboard.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_platform_user_interface_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_platform_user_interface_dashboard.png`
- Priority: P2
...
- Extracted palette: `#D0D0D0`, `#D0D0E0`, `#E0D0E0`, `#E0E0E0`, `#F0F0F0`, `#C0C0D0`
