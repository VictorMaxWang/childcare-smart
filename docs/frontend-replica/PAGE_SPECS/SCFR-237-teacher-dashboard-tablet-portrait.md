...
## Source
- Design file: `smartchildcare_images_part_08_of_08/images/teacher_health_document_processing_dashboard.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/teacher_health_document_processing_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `teacher_health_document_processing_dashboard.png`
- Priority: P0
- Original role: teacher
- Normalized role: teacher
- Page type: teacher, tablet
- Target route: `/teacher/health-file-bridge`
- Current project route: `/teacher/health-file-bridge`
- Route exists: yes
- Query state: none
- Hash state: none
...
- Main content: Route-specific content for modules: dashboard, health.
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#FFF0FF`, `#F0FFFF`
