# SCFR-035-director-diet-meal-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_meal_record_management_interface.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_meal_record_management_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_meal_record_management_interface.png`
- Priority: P1
...
- Extracted palette: `#C0C0D0`, `#C0C0C0`, `#FFFFFF`, `#F0F0F0`, `#B0B0C0`, `#E0E0E0`
