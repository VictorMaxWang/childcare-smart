# SCFR-153-director-diet-meal-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/meal_record_management_interface_with_batch_confir.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/meal_record_management_interface_with_batch_confir.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `meal_record_management_interface_with_batch_confir.png`
- Priority: P1
- Original role: director
- Normalized role: director
- Page type: director, state
...
- Extracted palette: `#D0D0D0`, `#C0C0D0`, `#C0C0C0`, `#FFFFFF`, `#F0F0F0`, `#D0C0D0`
