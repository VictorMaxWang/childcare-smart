# SCFR-096-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_platform_app_interface_screenshot.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_platform_app_interface_screenshot.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_platform_app_interface_screenshot.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#A0A0A0`, `#909090`, `#9090A0`, `#F0F0F0`
