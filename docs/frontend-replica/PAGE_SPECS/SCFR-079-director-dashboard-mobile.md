# SCFR-079-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_management_app_interface_design.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_management_app_interface_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_management_app_interface_design.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#E0E0E0`, `#E0E0FF`
