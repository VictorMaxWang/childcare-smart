# SCFR-118-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_weekly_report_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_weekly_report_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_weekly_report_dashboard_ui.png`
- Priority: P0
