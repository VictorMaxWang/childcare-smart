# SCFR-042-mobile-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_profile_page_mobile_ui_design.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_profile_page_mobile_ui_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_profile_page_mobile_ui_design.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0F0`, `#E0F0F0`, `#F0FFFF`
