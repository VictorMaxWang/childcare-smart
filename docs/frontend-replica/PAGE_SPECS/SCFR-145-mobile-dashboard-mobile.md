# SCFR-145-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/healthy_kids_app_interface_overview.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/healthy_kids_app_interface_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `healthy_kids_app_interface_overview.png`
- Priority: P1
