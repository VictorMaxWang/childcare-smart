# SCFR-133-shared-design-system-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/design_system_for_childcare_platform.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/design_system_for_childcare_platform.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `design_system_for_childcare_platform.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#E0E0FF`, `#FFFFF0`
