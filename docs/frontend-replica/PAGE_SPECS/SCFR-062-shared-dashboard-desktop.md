# SCFR-062-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/childcare_communication_platform_dashboard_layout.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/childcare_communication_platform_dashboard_layout.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_communication_platform_dashboard_layout.png`
- Priority: P1
