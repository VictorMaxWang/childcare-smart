# SCFR-137-parent-growth-storybook-mobile

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/growing_together_a_family_journey.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/growing_together_a_family_journey.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `growing_together_a_family_journey.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0F0`, `#FFF0F0`, `#E0E0E0`
