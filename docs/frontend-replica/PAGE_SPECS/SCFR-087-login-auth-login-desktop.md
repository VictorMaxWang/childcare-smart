# SCFR-087-login-auth-login-desktop

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_management_platform_login_page.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_management_platform_login_page.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_management_platform_login_page.png`
- Priority: P0
- Original role: login
...
- Extracted palette: `#F0F0FF`, `#FFFFFF`, `#F0F0F0`, `#E0E0F0`, `#E0E0FF`, `#E0F0FF`
