# SCFR-105-login-auth-login-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_platform_login_page_mockup.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_platform_login_page_mockup.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_platform_login_page_mockup.png`
- Priority: P0
- Original role: login
...
- Extracted palette: `#F0F0FF`, `#FFFFFF`, `#F0FFFF`, `#F0F0F0`, `#E0E0F0`, `#E0F0F0`
