# SCFR-150-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/kindergarten_weekly_report_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/kindergarten_weekly_report_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `kindergarten_weekly_report_dashboard_ui.png`
- Priority: P0
