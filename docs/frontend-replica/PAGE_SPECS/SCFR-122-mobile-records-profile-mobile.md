# SCFR-122-mobile-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/children_records_page_in_preschool_app.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/children_records_page_in_preschool_app.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `children_records_page_in_preschool_app.png`
- Priority: P2
