# SCFR-030-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/child_health_consultation_dashboard_in_pastel_ui.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/child_health_consultation_dashboard_in_pastel_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_health_consultation_dashboard_in_pastel_ui.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#E0E0FF`, `#E0F0F0`
