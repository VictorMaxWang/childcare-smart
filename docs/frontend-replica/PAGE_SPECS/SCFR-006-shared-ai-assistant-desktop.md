# SCFR-006-shared-ai-assistant-desktop

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/ai_assistant_workflow_in_child_care_center.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/ai_assistant_workflow_in_child_care_center.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `ai_assistant_workflow_in_child_care_center.png`
- Priority: P0
...
- Recommended prompts: 总结当前页面 / 解释风险指标 / 生成下一步建议
...
- Role differences: Shared AI surfaces must inherit role/session scope from the current route.
...
- Partially implemented / needs audit: AI assistant requires R06 vivo provider/server-boundary verification.
