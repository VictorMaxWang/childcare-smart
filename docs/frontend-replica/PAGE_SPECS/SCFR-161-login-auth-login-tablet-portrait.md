# SCFR-161-login-auth-login-tablet-portrait

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_login_ui_design.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_login_ui_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_childcare_platform_login_ui_design.png`
- Priority: P0
- Original role: login
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#F0FFFF`, `#E0E0F0`, `#E0E0FF`
