# SCFR-144-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/healthcare_management_dashboard_for_childcare_syst.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/healthcare_management_dashboard_for_childcare_syst.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `healthcare_management_dashboard_for_childcare_syst.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#FFF0F0`, `#FFFFF0`, `#F0FFFF`
