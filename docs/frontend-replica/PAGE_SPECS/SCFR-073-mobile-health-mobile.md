# SCFR-073-mobile-health-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_health_consultation_app_interface.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_health_consultation_app_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_health_consultation_app_interface.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#FFF0F0`, `#E0E0FF`, `#FFFFF0`
