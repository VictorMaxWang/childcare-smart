# SCFR-189-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/pastel_saas_weekly_report_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/pastel_saas_weekly_report_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `pastel_saas_weekly_report_dashboard.png`
- Priority: P0
