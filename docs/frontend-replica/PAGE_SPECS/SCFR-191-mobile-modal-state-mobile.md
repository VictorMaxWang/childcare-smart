# SCFR-191-mobile-modal-state-mobile

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/permission_denied_on_childcare_platform.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/permission_denied_on_childcare_platform.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `permission_denied_on_childcare_platform.png`
- Priority: P1
...
## Visual Tokens
- Primary color: #9090FF
- Secondary colors: #21C6C1 / #38BDF8 for informational accents when present.
- Background color: #FFFFFF
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0F0`, `#9090FF`, `#E0E0E0`
