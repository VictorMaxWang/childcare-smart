# SCFR-162-login-auth-login-desktop

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_registration_modal.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_childcare_platform_registration_modal.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_childcare_platform_registration_modal.png`
- Priority: P0
- Original role: login
...
- Extracted palette: `#9090A0`, `#90A0A0`, `#A0A0A0`, `#FFFFFF`, `#909090`, `#F0F0F0`
