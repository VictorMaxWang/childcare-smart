# SCFR-188-parent-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/pastel_family_growth_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/pastel_family_growth_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `pastel_family_growth_dashboard_interface.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#E0E0E0`, `#FFF0F0`, `#FFF0FF`
