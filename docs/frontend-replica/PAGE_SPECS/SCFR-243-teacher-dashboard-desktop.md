# SCFR-243-teacher-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/teacher_s_dashboard_for_child_archives.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/teacher_s_dashboard_for_child_archives.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `teacher_s_dashboard_for_child_archives.png`
- Priority: P0
...
- Extracted palette: `#F0F0FF`, `#F0F0F0`, `#FFFFFF`, `#FFF0FF`, `#E0E0F0`, `#FFF0F0`
