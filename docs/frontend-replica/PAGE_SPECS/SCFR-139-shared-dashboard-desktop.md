# SCFR-139-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/health_document_processing_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/health_document_processing_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `health_document_processing_dashboard_ui.png`
- Priority: P1
