# SCFR-246-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/weekly_operational_overview_dashboard_mockup.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/weekly_operational_overview_dashboard_mockup.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `weekly_operational_overview_dashboard_mockup.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#A0A0FF`, `#E0E0F0`
