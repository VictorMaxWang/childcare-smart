...
## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_risk_consultation_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_risk_consultation_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_risk_consultation_dashboard_interface.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#FFF0F0`, `#FFF0FF`
