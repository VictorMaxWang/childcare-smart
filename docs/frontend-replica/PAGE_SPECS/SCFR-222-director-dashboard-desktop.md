# SCFR-222-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_08_of_08/images/smartchildcare_dashboard_for_childcare_management.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/smartchildcare_dashboard_for_childcare_management.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smartchildcare_dashboard_for_childcare_management.png`
- Priority: P0
