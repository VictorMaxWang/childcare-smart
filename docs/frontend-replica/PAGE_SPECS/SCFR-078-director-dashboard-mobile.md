# SCFR-078-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_management_app_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_management_app_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_management_app_dashboard_ui.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#F0FFFF`, `#D0E0FF`
...
- Colors: #7080FF, #21C6C1, #F59E0B, #EF4444, #10B981
