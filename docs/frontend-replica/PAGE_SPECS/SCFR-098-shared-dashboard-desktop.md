# SCFR-098-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/childcare_platform_dashboard_mockup_design.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/childcare_platform_dashboard_mockup_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_platform_dashboard_mockup_design.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0F0`, `#E0E0FF`, `#F0FFFF`
...
- Colors: #8070FF, #21C6C1, #F59E0B, #EF4444, #10B981
