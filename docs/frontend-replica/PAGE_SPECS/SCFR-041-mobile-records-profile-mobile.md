# SCFR-041-mobile-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_profile_page_in_childcare_app.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_profile_page_in_childcare_app.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_profile_page_in_childcare_app.png`
- Priority: P2
