# SCFR-120-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_04_of_08/images/children_profile_management_dashboard_in_saas_inte.png`
- Actual file: `smartchildcare_images_part_04_of_08/images/children_profile_management_dashboard_in_saas_inte.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `children_profile_management_dashboard_in_saas_inte.png`
- Priority: P0
