# SCFR-091-director-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_meal_management_dashboard_design.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_meal_management_dashboard_design.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_meal_management_dashboard_design.png`
- Priority: P0
