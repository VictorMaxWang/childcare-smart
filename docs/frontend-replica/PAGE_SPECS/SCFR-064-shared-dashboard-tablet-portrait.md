# SCFR-064-shared-dashboard-tablet-portrait

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_consultation_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_consultation_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_consultation_dashboard_interface.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#F0FFFF`, `#E0E0E0`, `#FFFFF0`
