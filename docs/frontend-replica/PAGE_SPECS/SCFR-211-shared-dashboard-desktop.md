# SCFR-211-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_meal_tracking_dashboard.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_meal_tracking_dashboard.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_meal_tracking_dashboard.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#F0FFF0`, `#E0F0F0`
