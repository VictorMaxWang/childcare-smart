# SCFR-176-login-auth-login-desktop

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/modern_ui_login_page_with_marketing_features.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/modern_ui_login_page_with_marketing_features.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `modern_ui_login_page_with_marketing_features.png`
- Priority: P0
- Original role: login
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0FFFF`, `#F0F0F0`, `#E0E0E0`, `#E0E0F0`
