# SCFR-142-director-dashboard-tablet-portrait

## Source
- Design file: `smartchildcare_images_part_05_of_08/images/health_record_management_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/health_record_management_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `health_record_management_dashboard_interface.png`
- Priority: P0
