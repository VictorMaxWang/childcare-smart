# SCFR-075-mobile-dashboard-mobile

## Source
- Design file: `smartchildcare_images_part_03_of_08/images/childcare_health_monitoring_dashboard_ui.png`
- Actual file: `smartchildcare_images_part_03_of_08/images/childcare_health_monitoring_dashboard_ui.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_health_monitoring_dashboard_ui.png`
- Priority: P1
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#FFF0F0`, `#F0FFFF`, `#FFF0FF`
