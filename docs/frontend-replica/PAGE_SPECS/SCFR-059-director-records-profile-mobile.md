# SCFR-059-director-records-profile-mobile

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/childcare_app_profile_management_screen.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/childcare_app_profile_management_screen.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `childcare_app_profile_management_screen.png`
- Priority: P2
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#F0FFFF`, `#F0FFF0`, `#E0E0E0`
