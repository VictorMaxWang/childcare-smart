...
## Source
- Design file: `smartchildcare_images_part_08_of_08/images/智慧托育平台运营报表分析界面.png`
- Actual file: `smartchildcare_images_part_08_of_08/images/智慧托育平台运营报表分析界面.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `智慧托育平台运营报表分析界面.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#C0C0FF`, `#F0FFFF`, `#E0E0F0`
