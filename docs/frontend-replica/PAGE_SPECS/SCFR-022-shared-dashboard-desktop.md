# SCFR-022-shared-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_01_of_08/images/child_care_platform_dashboard_with_modal.png`
- Actual file: `smartchildcare_images_part_01_of_08/images/child_care_platform_dashboard_with_modal.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_care_platform_dashboard_with_modal.png`
- Priority: P1
...
## Visual Tokens
- Primary color: #C0D0E0
- Secondary colors: #21C6C1 / #38BDF8 for informational accents when present.
- Background color: #D0E0E0
- Extracted palette: `#D0E0E0`, `#D0D0E0`, `#E0E0E0`, `#FFFFFF`, `#F0F0F0`, `#E0E0F0`
...
- Required interactions: chart hover tooltip; legend scan; loading/empty/error state handling; open/close modal or drawer; confirm/cancel state; keyboard/overlay dismissal
...
- Colors: #C0D0E0, #21C6C1, #F59E0B, #EF4444, #10B981
