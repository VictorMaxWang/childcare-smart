# SCFR-209-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_07_of_08/images/smart_childcare_management_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_07_of_08/images/smart_childcare_management_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `smart_childcare_management_dashboard_overview.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0F0`, `#F0F0FF`, `#E0E0E0`, `#FFF0F0`, `#F0FFFF`
