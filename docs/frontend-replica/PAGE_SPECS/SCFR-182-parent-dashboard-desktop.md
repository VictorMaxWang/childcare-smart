# SCFR-182-parent-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_06_of_08/images/parenting_app_dashboard_in_pastel_tones.png`
- Actual file: `smartchildcare_images_part_06_of_08/images/parenting_app_dashboard_in_pastel_tones.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `parenting_app_dashboard_in_pastel_tones.png`
- Priority: P0
...
- Extracted palette: `#FFFFFF`, `#F0F0FF`, `#F0F0F0`, `#D0D0FF`, `#E0E0FF`, `#E0E0E0`
