# SCFR-043-director-dashboard-desktop

## Source
- Design file: `smartchildcare_images_part_02_of_08/images/child_record_management_dashboard_interface.png`
- Actual file: `smartchildcare_images_part_02_of_08/images/child_record_management_dashboard_interface.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `child_record_management_dashboard_interface.png`
- Priority: P0
...
- Extracted palette: `#F0F0FF`, `#FFFFFF`, `#F0F0F0`, `#E0E0F0`, `#E0F0F0`, `#E0E0E0`
