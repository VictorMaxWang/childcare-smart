...
## Source
- Design file: `smartchildcare_images_part_05_of_08/images/class_management_dashboard_overview.png`
- Actual file: `smartchildcare_images_part_05_of_08/images/class_management_dashboard_overview.png`
- Source status: ok (Inventory path exists on disk.)
- File name: `class_management_dashboard_overview.png`
- Priority: P0
