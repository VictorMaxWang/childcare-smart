...
- 本地代码验证已通过 `lint`、`typecheck`、production build、543 项 Node、227 项 Python 和发布浏览器套件；浏览器套件为 80 通过、3 项真实账号规格明确跳过，当前只能声明本地回归通过。
...
- 生产 SQL、部署、现有/新建三账号闭环和 live AI 仍待执行，当前不能宣称线上已修复。
